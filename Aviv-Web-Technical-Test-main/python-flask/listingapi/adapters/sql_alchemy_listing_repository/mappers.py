from listingapi.adapters.sql_alchemy_listing_repository.models import ListingModel, PriceHistoryModel
...
class ListingMapper:
    ...
    def from_model_to_dict_prices(listing: PriceHistoryModel) -> dict:
        listing_dict = {
